        ...
        i &&
          (async () => {
            ...
            let u = document.getElementById("draggable"),
              ...
              O = null,
              D = c().startOf("day"),
              S = D.clone().subtract(1, "day").format("YYYY-MM-DD"),
            ...
            let j = (e) => {
              (O = e.event),
                ...
                p.show(),
                (g.value = O.title),
                (k.value = O.classNames[0]),
                O.extendedProps.location &&
                  (w.value = O.extendedProps.location),
                O.extendedProps.description &&
                  (E.value = O.extendedProps.description),
                O.start && (b.value = c(O.start).format("MM/DD/YYYY")),
                O.start && (_.value = c(O.start).format("HH:mm")),
                O.end && (v.value = c(O.end).format("MM/DD/YYYY")),
                O.end && (y.value = c(O.end).format("HH:mm")),
                (A.checked = O.allDay),
                P();
              let t = b._flatpickr,
                n = v._flatpickr,
  ...
  (r.m = s),
    ...
    (() => {
      ...
      function B(e, t, n) {
        ...
        t &&
          D(e) &&
          ((s = (e.offsetWidth > 0 && j(i.width) / e.offsetWidth) || 1),
          (o = (e.offsetHeight > 0 && j(i.height) / e.offsetHeight) || 1));
        var r = (O(e) ? x(e) : window).visualViewport,
          a = !q() && n,
      ...
      function V(e) {
        for (var t = x(e), n = R(e); n && Y(n) && "static" === H(n).position; )
          n = R(n);
        return n &&
          ("html" === C(n) || ("body" === C(n) && "static" === H(n).position))
          ? t
          : n ||
              (function (e) {
                var t = /firefox/i.test(P());
                if (/Trident/i.test(P()) && D(e) && "fixed" === H(e).position)
                  return null;
                var n = W(e);
                for (
                  S(n) && (n = n.host);
                  D(n) && ["html", "body"].indexOf(C(n)) < 0;
      ...
      function be(e, s) {
        ...
        var o = s,
          ...
          x = e.rects.popper,
          D = e.elements[E ? C : y],
          S = me(O(D) ? D : D.contextElement || F(e.elements.popper), g, _, f),
          ...
          if (!r.modifiersData[d]._skip) {
            for (
              var u = c.mainAxis,
                ...
                O = [T].concat(x).reduce(function (e, t) {
                  return e.concat(
                    I(t) === o
                      ? (function (e, t) {
                          void 0 === t && (t = {});
          ...
          if (x) {
            if (d) {
              var q,
                ...
                ie = U(0, O[H], G[H]),
                se = k
                  ? O[H] / 2 - R - ie - te - L.mainAxis
                  : J - ie - te - L.mainAxis,
                oe = k
                  ? -O[H] / 2 + R + ie + ne + L.mainAxis
                  : K + ie + ne + L.mainAxis,
            ...
            if (h) {
              var ue,
                ...
                we = ve ? ge : fe - O[me] - D[me] - ye + L.altAxis,
                Ee = ve ? fe + O[me] + D[me] - ye - L.altAxis : _e,
                Ae =
                  _ && ve
                    ? (function (e, t, n) {
                        var i = U(e, t, n);
      ...
      var Se = De(),
        Le = De({ defaultModifiers: [ie, Ae, te, L, Ee, _e, ke, Q, we] }),
        Ie = De({ defaultModifiers: [ie, Ae, te, L] });
      ...
      class St extends yt {
        ...
        _initEvents() {
          this._supportPointerEvents
            ? (pt.on(this._element, "pointerdown.bs.swipe", (e) =>
                this._start(e)
              ),
              pt.on(this._element, "pointerup.bs.swipe", (e) => this._end(e)),
              this._element.classList.add("pointer-event"))
            : (pt.on(this._element, "touchstart.bs.swipe", (e) =>
                this._start(e)
              ),
      ...
      class Ft extends wt {
        ...
        _maybeEnableCycle() {
          this._config.ride &&
            (this._isSliding
              ? pt.one(this._element, jt, () => this.cycle())
              : this.cycle());
        }
        to(e) {
          ...
          if (this._isSliding)
            return void pt.one(this._element, jt, () => this.to(e));
        ...
        _addEventListeners() {
          this._config.keyboard &&
            ...
            "hover" === this._config.pause &&
              (pt.on(this._element, "mouseenter.bs.carousel", () =>
                this.pause()
              ),
              pt.on(this._element, "mouseleave.bs.carousel", () =>
        ...
        _addTouchEventListeners() {
          for (const e of Ct.find(".carousel-item img", this._element))
      ...
      class Kt extends wt {
          ...
          this._queueCallback(
            () => {
              (this._isTransitioning = !1),
                ...
                this._element.classList.add(Rt, Wt),
        ...
        hide() {
          ...
          (this._element.style[e] = `${
            ...
            We(this._element),
            this._element.classList.add(Vt),
            this._element.classList.remove(Rt, Wt);
      ...
      class mn extends wt {
        constructor(e, t) {
          super(e, t),
            ...
            (this._menu =
              Ct.next(this._element, rn)[0] ||
              Ct.prev(this._element, rn)[0] ||
              Ct.findOne(rn, this._parent)),
        ...
        show() {
          ...
          if (
            !pt.trigger(this._element, "show.bs.dropdown", e).defaultPrevented
          ) {
            if (
              (this._createPopper(),
              "ontouchstart" in document.documentElement &&
        ...
        static dataApiKeydownHandler(e) {
          ...
          if (t && !n) return;
          e.preventDefault();
          const s = this.matches(sn)
              ? this
              : Ct.prev(this, sn)[0] ||
                Ct.next(this, sn)[0] ||
                Ct.findOne(sn, e.delegateTarget.parentNode),
      ...
      class yn {
        ...
        hide() {
          ...
          this._disableOverFlow(),
            ...
            this._setElementAttributes(gn, _n, (t) => t + e),
            this._setElementAttributes(bn, vn, (t) => t - e);
        }
        reset() {
          this._resetElementAttributes(this._element, "overflow"),
            this._resetElementAttributes(this._element, _n),
            this._resetElementAttributes(gn, _n),
            this._resetElementAttributes(bn, vn);
        }
        isOverflowing() {
      ...
      class $n extends wt {
        ...
        show(e) {
          ...
          pt.trigger(this._element, Nn, { relatedTarget: e })
            .defaultPrevented ||
            ((this._isShown = !0),
            (this._isTransitioning = !0),
      ...
      pt.on(
        ...
        pt.on(window, "resize.bs.offcanvas", () => {
          for (const e of Ct.find(
            "[aria-modal][class*=show][class*=offcanvas-]"
          ))
            "fixed" !== getComputedStyle(e).position &&
              Jn.getOrCreateInstance(e).hide();
        }),
        Et(Jn),
        Ue(Jn);
      const Kn = new Set([
        ...
        Gn = (e, t) => {
          ...
          return t.includes(n)
            ? !Kn.has(n) ||
                Boolean(Qn.test(e.nodeValue) || Xn.test(e.nodeValue))
      ...
      class si extends yt {
        ...
        _checkContent(e) {
          for (const [t, n] of Object.entries(e))
            super._typeCheckConfig({ selector: t, entry: n }, ii);
        }
        _setContent(e, t, n) {
          ...
          i &&
            ((t = this._resolvePossibleFunction(t))
              ? Be(t)
                ? this._putElementInTemplate(ze(t), i)
                : this._config.html
      ...
      class mi extends wt {
        ...
        show() {
          ...
          const e = pt.trigger(
            ...
            t = (
              Ye(this._element) || this._element.ownerDocument.documentElement
        ...
        hide() {
          ...
          if (
            (e.classList.remove(ai), "ontouchstart" in document.documentElement)
          )
            for (const e of [].concat(...document.body.children))
              pt.off(e, "mouseover", Fe);
          ...
          for (const t of e)
            if ("click" === t)
              ...
              pt.on(this._element, e, this._config.selector, (e) => {
                ...
                (t._activeTrigger["focusin" === e.type ? ui : di] = !0),
                  t._enter();
              }),
                pt.on(this._element, n, this._config.selector, (e) => {
                  const t = this._initializeOnDelegatedTarget(e);
                  (t._activeTrigger["focusout" === e.type ? ui : di] =
      ...
      class ki extends wt {
        ...
        _process(e) {
          this._activeTarget !== e &&
            ...
            pt.trigger(this._element, "activate.bs.scrollspy", {
              relatedTarget: e,
            }));
        }
        _activateParents(e) {
      ...
      pt.on(window, "load.bs.scrollspy.data-api", () => {
        for (const e of Ct.find('[data-bs-spy="scroll"]'))
      ...
      class Ni extends wt {
        constructor(e) {
          super(e),
            ...
            this._parent &&
              ...
              pt.on(this._element, "keydown.bs.tab", (e) => this._keydown(e)));
        }
        static get NAME() {
          return "tab";
        }
        show() {
          ...
          pt.trigger(e, "show.bs.tab", { relatedTarget: t }).defaultPrevented ||
            (n && n.defaultPrevented) ||
            (this._deactivate(t, e), this._activate(e, t));
        }
        _activate(e, t) {
          if (!e) return;
          e.classList.add(Di), this._activate(Pe(e));
          this._queueCallback(
            () => {
              "tab" === e.getAttribute("role")
                ? (e.removeAttribute("tabindex"),
                  ...
                  pt.trigger(e, "shown.bs.tab", { relatedTarget: t }))
                : e.classList.add(Li);
            },
            e,
        ...
        _deactivate(e, t) {
          if (!e) return;
          e.classList.remove(Di), e.blur(), this._deactivate(Pe(e));
          this._queueCallback(
            () => {
              "tab" === e.getAttribute("role")
                ? (e.setAttribute("aria-selected", !1),
                  ...
                  pt.trigger(e, "hidden.bs.tab", { relatedTarget: t }))
        ...
        _keydown(e) {
          if (![Ti, Ci, xi, Oi].includes(e.key)) return;
          e.stopPropagation(), e.preventDefault();
          const t = [Ci, Oi].includes(e.key),
            n = Qe(
      ...
      pt.on(document, "click.bs.tab", Ii, function (e) {
        ["A", "AREA"].includes(this.tagName) && e.preventDefault(),
          He(this) || Ni.getOrCreateInstance(this).show();
      }),
            ...
            this._queueCallback(
              () => {
                this._element.classList.add(ji),
                  this._element.classList.remove(qi, Pi),
                    ...
                    backgroundColor: (e) => {
                      ...
                      return i
                        ? Ui.Z(
                            n,
                            i,
                            `rgba(${Zi.Z(`${Ji}primary-rgb`)}, 0.5)`,
                            `rgba(${Zi.Z(`${Ji}primary-rgb`)}, 0.2)`,
                            `rgba(${Zi.Z(`${Ji}primary-rgb`)}, 0)`
                          )
                        : null;
                    },
                    data: [
                    ...
                    backgroundColor: (e) => {
                      ...
                      return i
                        ? Ui.Z(
                            n,
                            i,
                            `rgba(${Zi.Z(`${Ji}white-rgb`)}, 0.6)`,
                            `rgba(${Zi.Z(`${Ji}white-rgb`)}, 0.3)`,
                            `rgba(${Zi.Z(`${Ji}white-rgb`)}, 0)`
                          )
                        : null;
                    },
                    borderWidth: 3,
